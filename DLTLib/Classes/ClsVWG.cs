...
namespace DLTLib.Classes
{
    public class ClsVWG
    {
        ...
        public static void FillCmbBySQL(ComboBox cmb, string aSelect, string aCntStr,
            bool insFirstLine = false, bool show2Cols = false)
        {
            DataTable dt = ClsMSSQL.GetDataTable(aSelect, aCntStr);
            if (insFirstLine)
            {
        ...
        /// <returns></returns>
        public static DataSeries DataTableToDataSeries(string aSelect, string aCntStr,
            string xField, string yField, bool isPerc = true, string tooltip = "", List<string> arr_dataSeriesLable = null)
        {
